    ...
    <>
      ...
      {mobileOpen && (
        <div className="mobile-nav">
          ...
          <button
            onClick={toggleDark}
            className="mobile-nav-link mobile-dark-toggle bg-transparent border-none cursor-pointer flex items-center gap-3"
            aria-label="Toggle dark mode"
          >
            <span style={{ font: "700 20px/1 'Archivo',sans-serif", letterSpacing: '0.14em', color: '#0a0a0a' }}>
              {dark ? 'LIGHT MODE' : 'DARK MODE'}
            </span>
            <span style={{ display: 'flex', alignItems: 'center', color: '#0a0a0a' }}>
              {dark ? (
